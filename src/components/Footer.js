        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <Link href="/reviews" className="text-gray-400 hover:text-white transition-colors">Отзывы</Link>
              <Link href="/about" className="text-gray-400 hover:text-white transition-colors">О нас</Link>
